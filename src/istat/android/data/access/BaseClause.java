...
public abstract class BaseClause<Clause extends BaseClause<?>> {
	...
	protected BaseClause(String table, String[] projection) {
		this.table = table;
	...
	protected BaseClause(Class<? extends Queryable> clazz) {
		// TODO Auto-generated constructor stub
	...
	@SuppressWarnings("unchecked")
	public Clause AND(SelectClause close) {

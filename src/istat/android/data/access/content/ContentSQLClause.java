...
abstract class ContentSQLClause<Clause extends ContentSQLClause<?>> implements ContentSQLClauseAble {
    protected ContentSQL.SQL sql;
...
//    ContentSQLClause(Class<?> clazz, String table, String[] projection, ContentSQL.SQL sql) {
//        this.table = table;
...
//    }
    ...
    ContentSQLClause(Class<?> clazz, ContentSQL.SQL sql) {
        this.sql = sql;
        this.tableClass = clazz;
        QueryAble entity = null;
        try {
            entity = ContentSQLModel.fromClass(clazz);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (entity != null) {
    ...
    @SuppressWarnings("unchecked")
    public Clause WHERE(ContentSQLSelect close) {
        if (whereClause == null) {
    ...
    @SuppressWarnings("unchecked")
    public Clause OR(ContentSQLSelect close) {
    ...
    @SuppressWarnings("unchecked")
    public Clause AND(ContentSQLSelect close) {
        if (!TextUtils.isEmpty(this.whereClause)) {
    ...
    protected abstract Object onExecute(ContentResolver db);
    ...
    public class ClauseBuilder {
        ...
        public Clause isNULL() {
            ...
            return (Clause) ContentSQLClause.this;
        }
        ...
        //------------------------------------------------
        @SuppressWarnings("unchecked")
        public Clause equalTo(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" = (" + value + ") ");
            return (Clause) ContentSQLClause.this;
        }

        public Clause notEqualTo(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" != (" + value + ") ");
            return (Clause) ContentSQLClause.this;
        }

        public Clause notIn(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" NOT IN (" + value.getSql() + ") ");
            return (Clause) ContentSQLClause.this;
        }

        public Clause in(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" IN (" + value.getSql() + ") ");
            return (Clause) ContentSQLClause.this;
        }

        public Clause greatThan(ContentSQLSelect value) {
            return greatThan(value, false);
        }

        public Clause lessThan(ContentSQLSelect value) {
            return lessThan(value, false);
        }

        @SuppressWarnings("unchecked")
        public Clause greatThan(ContentSQLSelect value, boolean acceptEqual) {
            whereParams.addAll(value.whereParams);
        ...
        @SuppressWarnings("unchecked")
        public Clause lessThan(ContentSQLSelect value, boolean acceptEqual) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" <" + (acceptEqual ? "=" : "") + " (" + value.getSql() + ") ");
            return (Clause) ContentSQLClause.this;
        }
        ...
        @SuppressWarnings("unchecked")
        public Clause like(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
        ...
        @SuppressWarnings("unchecked")
        public Clause notLike(ContentSQLSelect value) {
            whereParams.addAll(value.whereParams);
        ...
        @SuppressWarnings("unchecked")
        public Clause between(ContentSQLSelect value, ContentSQLSelect value2) {
            whereParams.addAll(value.whereParams);
        ...
        @SuppressWarnings("unchecked")
        public Clause notBetween(ContentSQLSelect value, ContentSQLSelect value2) {
            whereParams.addAll(value.whereParams);
            whereClause.append(" BETWEEN (" + value.getSql() + ") AND (" + value2.getSql() + ")");
            return (Clause) ContentSQLClause.this;
        }
